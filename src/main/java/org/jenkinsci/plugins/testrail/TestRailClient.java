...
public class TestRailClient {
    ...
    public TestRailResponse addResultsForCases(int runId, Results results, String environment)
        ...
        for (int i = 0; i < results.getResults().size(); i++) {
            ...
            o.put("case_id", r.getCaseId()).put("status_id", r.getStatus().getValue()).put("custom_stacktrace", r.getComment()).put("elapsed", r.getElapsedTimeString()).put("version", environment);
            a.put(o);
        }
